    ...
    sections: [
      {
        ...
        content: [
          ...
          "Çocuğunuzun ortopedik gelişimi konusunda endişeleriniz varsa, [Arıkan Ortopedi - Ortez & Protez](https://ortezprotez.com/) uzman ekibiyle görüşerek erken değerlendirme yaptırabilirsiniz.",
        ],
      },
      {
        id: "gelisim-donemu",
