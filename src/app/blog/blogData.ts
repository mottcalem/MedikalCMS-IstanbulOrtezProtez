...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        level: 2,
        content: [
          "İstanbul Ortez Protez Kütahya merkezimizde diz altı, diz üstü ve tüm alt ekstremite protezleri için kapsamlı hizmet sunulmaktadır.",
          ...
          "Ampute değerlendirmesi için ücretsiz randevu alabilirsiniz: 0274 226 07 17 veya WhatsApp.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        content: [
          ...
          "İstanbul Ortez Protez Kütahya merkezimiz tam SGK anlaşmalıdır. Bu sayede Kütahya ve çevresindeki hastalarımız SGK garantörlüğü altında ortez ve protez hizmetlerine erişebilir.",
        ],
      },
      {
        id: "gerekli-evraklar",
      ...
      },
      {
        ...
        content: [
          ...
          "Merkezimiz, yenileme zamanı yaklaşan hastalarımıza proaktif olarak bildirim yapmaktadır. Sorularınız için 0274 226 07 17 veya WhatsApp hattımızdan bize ulaşabilirsiniz.",
        ],
      },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        level: 2,
        content: [
          "İstanbul Ortez Protez Kütahya merkezimiz, yukarıdaki tüm kriterleri karşılayan tam donanımlı bir ortez protez merkezidir.",
          "Uzman kadromuz, SGK anlaşmalı hizmetlerimiz, 3D tarama ve CAD/CAM teknolojimiz, 15 yılı aşkın deneyimimiz ve kapsamlı takip hizmetlerimizle Kütahya ve çevresinde güvenilir çözümler sunuyoruz. Ücretsiz ön değerlendirme için bizi arayabilirsiniz: 0274 226 07 17.",
        ],
      },
    ],
  },
